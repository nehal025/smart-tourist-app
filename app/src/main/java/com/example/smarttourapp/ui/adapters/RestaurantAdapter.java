...
public class RestaurantAdapter  extends RecyclerView.Adapter<RestaurantAdapter.MyViewHolder> {
    ...
    private List<Restaurant> articles;
    private Context context;
    private OnItemClickListener mListener;

    public RestaurantAdapter(List<Restaurant> articles, Context context) {
    ...
    public RestaurantAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new RestaurantAdapter.MyViewHolder(view, mListener);
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull RestaurantAdapter.MyViewHolder holders, int position) {
        final RestaurantAdapter.MyViewHolder holder = holders;
        Restaurant model = articles.get(position);
