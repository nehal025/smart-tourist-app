package com.example.smarttourapp.ui.camera;
...
import com.example.smarttourapp.ui.activities.FoodClassifier;
        ...
        captureImage.setOnClickListener(v -> imageCapture.takePicture(executor, new ImageCapture.OnImageCapturedCallback() {
            ...
            public void onCaptureSuccess(@NonNull ImageProxy image) {
                ...
                if (role.equals("locationDetect")) {
                    intent = new Intent(getApplicationContext(), LocationClassifier.class);
